  ...
  displayMusic() {
    ...
    background(0);
          ...
          image(youtubeLogo, 3*window.innerWidth/4, window.innerHeight/2 + screenPushAmount,100,100);  
              ...
              */
            spotifyLink.position(width/2 - 25, 250);
            appleMusicLink.position(width/2 - 39, 450);
            youtubeLink.position(width/2 - 25, 650);
            soundcloudLink.position(width/2 - 37, 850);

            image(spotifyLogo, width/2, 200 + screenPushAmount,100,100);
            image(appleLogo, width/2, 400 + screenPushAmount,100,100);
            image(youtubeLogo, width/2, 600 + screenPushAmount,100,100);  
            image(soundcloudLogo, width/2, 800 + screenPushAmount,100,100);  
        //  }
        pop();
