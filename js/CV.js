class CV {
  ...
  displayCV() {
   ...
   // image(detective, 960, 540);
    ...
    text(`CV Page`, windowWidth/2, windowHeight/2 + screenPushAmount);
    pop();
...
Music composition and performance: Plays guitar, bass, piano, drums, alto saxophone and works in a variety of genres including, but not limited to classical, rock, metal, electronic, hip-hop, jazz, and funk. 

Audio for Film/tv/games: Composing, Foley, and sound design.

Audio editing: Logic Pro, Pro Tools, Ableton, FL, Nuendo.

video editing: Adobe Creative Suite, Final Cut, Blender, Rhinoceros 3D, Procreate, and the Microsoft Office. I also have access to a wide variety of industry standard equipment and plugins.
...
Visual artist and craftsman: paints/draws, writes graphic novels, animates, creates sculptures (woodworking, basic welding, and ceramics), does photography/videography, likes to work with clothes (sewing and dying).
`;
            ...
            noStroke();
            textAlign(CENTER);
            textSize(19 * (windowWidth/1750));
            textFont('Times New Roman');
            text(cvText, windowWidth/2, windowHeight/7 + screenPushAmount);
            pop();

            push();
            rectMode(CENTER);
            fill(0);
            rect(windowWidth/2, 20, windowWidth*2, 180 + screenPushAmount);
            pop();
            ...
            menuToggle = 0;
              ...
              if(mouseX < windowWidth - 84 && mouseX > windowWidth - 265 && mouseY > 210 + screenPushAmount && mouseY < 250 + screenPushAmount){
                ...
                menuToggle = 0;
                  ...
                  if(mouseX < windowWidth - 115 && mouseX > windowWidth - 265 && mouseY > 268 + screenPushAmount && mouseY < 304 + screenPushAmount){
                    state = `contact`;
                    menuToggle = 0;
                      }
