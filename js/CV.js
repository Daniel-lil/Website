class CV {
  ...
  displayCV() {
   ...
   // image(detective, 960, 540);
    ...
    text(`CV Page`, window.innerWidth/2, window.innerHeight/2 + screenPushAmount);
    pop();
...
`;
            ...
            noStroke();
            textAlign(CENTER);
            textSize(19 * (window.innerWidth/1750));
            textFont('Times New Roman');
            text(cvText, window.innerWidth/2, window.innerHeight/7 + screenPushAmount);
            pop();
