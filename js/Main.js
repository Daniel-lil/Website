...
strokeWeight(3);
    if (mouseX > 310 || mouseY > 102 + screenPushAmount) {
      ...
      if (mouseX > buttonX1 - buttonSizeX/2 && mouseX < buttonX1 + buttonSizeX/2) {
        if (mouseY > buttonY1 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY/2 + screenPushAmount) {
          text(`Video`, buttonX1, buttonY1 + screenPushAmount);
        }
      }
          if (mouseX > buttonX1 - buttonSizeX/2 && mouseX < buttonX1 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*1.03 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*1.03 + buttonSizeY/2 + screenPushAmount) {
              text(`Drawing`, buttonX1, buttonY1 + buttonSizeY*1.03 + screenPushAmount);
            } 
          }
          ...
          if (mouseX > buttonX1 - buttonSizeX/2 && mouseX < buttonX1 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*2.06 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*2.06 + buttonSizeY/2 + screenPushAmount) {
              text(`CV`, buttonX1, buttonY1 + buttonSizeY*2.06 + screenPushAmount);
            } 
          }
    
          if (mouseX > buttonX2 - buttonSizeX/2 && mouseX < buttonX2 + buttonSizeX/2) {
            if (mouseY > buttonY1 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY/2 + screenPushAmount) {
              text(`Music`, buttonX2, buttonY1 + screenPushAmount);
            } 
          }
    
          if (mouseX > buttonX2 - buttonSizeX/2 && mouseX < buttonX2 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*1.03 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*1.03 + buttonSizeY/2 + screenPushAmount) {
              text(`Programming`, buttonX2, buttonY1 + buttonSizeY*1.03 + screenPushAmount);
            } 
          }
    
          if (mouseX > buttonX2 - buttonSizeX/2 && mouseX < buttonX2 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*2.06 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*2.06 + buttonSizeY/2 + screenPushAmount) {
              text(`Contact`, buttonX2, buttonY1 + buttonSizeY*2.06 + screenPushAmount);
            } 
          }
        } 
  }
  ...
  pop();
    ...
    text(`Music`, buttonX1, buttonY1 + buttonSizeY*1.03 + screenPushAmount);
    
    textSize(mainTextSize + buttonTextSizeBoostDrawing);
    text(`Drawing`, buttonX1, buttonY1 + buttonSizeY*2.06 + screenPushAmount);
    
    textSize(mainTextSize + buttonTextSizeBoostProgramming);
    text(`Programming`, buttonX2, buttonY1 + buttonSizeY*3.09 + screenPushAmount);
    
    textSize(mainTextSize + buttonTextSizeBoostCV);
    text(`CV`, buttonX2, buttonY1 + buttonSizeY*4.12 + screenPushAmount);
    
    textSize(mainTextSize + buttonTextSizeBoostContact);
    text(`Contact`, buttonX2, buttonY1 + buttonSizeY*5.15 + screenPushAmount);
