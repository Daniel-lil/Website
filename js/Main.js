class Main {
  ...
  displayImages() {
    ...
    fill(0,0,0,0)
    noStroke();
    rect(windowWidth - 90, 22 + screenPushAmount, 80, 80);
...
text(`_`, windowWidth - 50, 75 + screenPushAmount);
  ...
  displayImagesVertical() {
    ...
    if (mouseX > 310 || mouseY > 102 + screenPushAmount) {
      if (mouseX > windowWidth - 25 || mouseX < menuDetectx ||mouseY < 42 + screenPushAmount || mouseY > menuDetecty + screenPushAmount) {
        push();
      if (mouseX > buttonX1 - buttonSizeX/2 && mouseX < buttonX1 + buttonSizeX/2) {
        if (mouseY > buttonY1 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY/2 + screenPushAmount) {
          textFont(oldEnglish);
          ...
          fill(0);
          stroke(0);
          text(`Video`, buttonX1, buttonY1 + windowHeight/60 + screenPushAmount);
        }
      }
          if (mouseX > buttonX1 - buttonSizeX/2 && mouseX < buttonX1 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*1.03 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*1.03 + buttonSizeY/2 + screenPushAmount) {
              ...
              fill(0);
              stroke(0);
              text(`Music`, buttonX1, buttonY1 + buttonSizeY*1.03 + windowHeight/60 + screenPushAmount);
              //music
            } 
          }
          ...
          if (mouseX > buttonX1 - buttonSizeX/2 && mouseX < buttonX1 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*2.06 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*2.06 + buttonSizeY/2 + screenPushAmount) {
              ...
              fill(0);
              stroke(0);
              text(`Drawing`, buttonX1, buttonY1 + buttonSizeY*2.06 + windowHeight/60 + screenPushAmount);
              //draw
            } 
          }
          ...
          if (mouseX > buttonX2 - buttonSizeX/2 && mouseX < buttonX2 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*3.09 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*3.09 + buttonSizeY/2 + screenPushAmount) {
              ...
              fill(0);
              stroke(0);
              text(`Programming`, buttonX2, buttonY1 + buttonSizeY*3.09 + windowHeight/60 + screenPushAmount);
              //programming
            } 
          }
          ...
          if (mouseX > buttonX2 - buttonSizeX/2 && mouseX < buttonX2 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*4.12 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*4.12 + buttonSizeY/2 + screenPushAmount) {
              ...
              fill(0);
              stroke(0);
              text(`CV`, buttonX2, buttonY1 + buttonSizeY*4.12 + windowHeight/60 + screenPushAmount);
              //music
            } 
          }
          ...
          if (mouseX > buttonX2 - buttonSizeX/2 && mouseX < buttonX2 + buttonSizeX/2) {
            if (mouseY > buttonY1 + buttonSizeY*5.15 - buttonSizeY/2 + screenPushAmount && mouseY < buttonY1 + buttonSizeY*5.15 + buttonSizeY/2 + screenPushAmount) {
              ...
              fill(0);
              stroke(0);
              text(`Contact`, buttonX2, buttonY1 + buttonSizeY*5.15 + windowHeight/60 + screenPushAmount);
            } 
          }
        } 
  }
            ...
            menuToggle = 0;
              ...
              if(mouseX < windowWidth - 218 && mouseX > windowWidth - 265 && mouseY > 268 + screenPushAmount && mouseY < 304 + screenPushAmount){
                ...
                menuToggle = 0;
                  ...
                  if(mouseX < windowWidth - 164 && mouseX > windowWidth - 265 && mouseY > 322 + screenPushAmount && mouseY < 362 + screenPushAmount){
                    state = `contact`;
                    menuToggle = 0;
                      }
  }
