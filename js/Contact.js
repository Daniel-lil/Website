class Contact {
  ...
  displayContact() {
    ...
    pop();
            ...
            text(`Contact Page`, window.innerWidth/2, window.innerHeight/2 + screenPushAmount);
            pop();

            push();
            imageMode(CENTER);
            image(instagramLogo, window.innerWidth/4, window.innerHeight/2 + screenPushAmount,100,100);
            image(emailLogo, 2*window.innerWidth/4, window.innerHeight/2 + screenPushAmount,100,100);
            ...
            instagramLink.position(window.innerWidth/4 - 31, window.innerHeight/1.82);
            youtubeLink.position(3*window.innerWidth/4 - 25, window.innerHeight/1.82);
            gmailLink.position(2*window.innerWidth/4 - 95, window.innerHeight/1.82);
